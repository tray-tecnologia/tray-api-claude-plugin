 ...
 * Run: TRAY_PRICE_LIST_ID=5 node skills/listas-preco-b2b/examples/lista-preco-atualizar.node.mjs
...
const payload = JSON.parse(
  await readFile(new URL('./lista-preco-atualizar.fixture.json', import.meta.url))
);
