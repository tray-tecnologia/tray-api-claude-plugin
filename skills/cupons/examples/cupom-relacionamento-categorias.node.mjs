#!/usr/bin/env node
/**
 * Exemplo: Listar categorias vinculadas a um cupom via API Tray
 * Run: TRAY_COUPON_ID=7 node skills/cupons/examples/cupom-relacionamento-categorias.node.mjs
 * Doc: https://developers.tray.com.br/#api-de-cupom
 * Quando usar: consultar as categorias associadas a um cupom.
...
const url = new URL(`${TRAY_API_BASE}/discount_coupons/category_relationship/${TRAY_COUPON_ID}`);
