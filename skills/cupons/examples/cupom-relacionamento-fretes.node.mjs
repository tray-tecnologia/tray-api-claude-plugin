#!/usr/bin/env node
/**
 * Exemplo: Listar fretes vinculados a um cupom via API Tray
 * Run: TRAY_COUPON_ID=7 node skills/cupons/examples/cupom-relacionamento-fretes.node.mjs
 * Doc: https://developers.tray.com.br/#api-de-cupom
 * Quando usar: consultar os métodos de envio associados a um cupom de frete.
...
const url = new URL(`${TRAY_API_BASE}/discount_coupons/shipping_relationship/${TRAY_COUPON_ID}`);
