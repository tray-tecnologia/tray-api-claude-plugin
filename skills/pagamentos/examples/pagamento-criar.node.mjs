 ...
 * Run: node skills/pagamentos/examples/pagamento-criar.node.mjs
...
const payload = JSON.parse(
  await readFile(new URL('./pagamento-criar.fixture.json', import.meta.url))
);

const url = new URL(`${TRAY_API_BASE}/payments`);
