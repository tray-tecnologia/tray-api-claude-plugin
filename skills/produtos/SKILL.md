...
when_not_to_use: >
  Não use para variações/SKUs (use tray-variacoes), imagens (use tray-imagens-produtos),
...
- **OBRIGATÓRIO:** `node skills/produtos/scripts/validate.mjs '<payload_json>'` — valide a estrutura do payload antes de retornar código ao usuário.
