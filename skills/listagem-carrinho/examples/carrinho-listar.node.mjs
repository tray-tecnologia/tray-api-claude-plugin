 ...
 * Run: node skills/listagem-carrinho/examples/carrinho-listar.node.mjs
 * Doc: https://developers.tray.com.br/#novo-api-de-listagem-de-carrinho
 * Quando usar: listar todos os carrinhos da loja. Máximo 50 itens por página.
...
const url = new URL(`${TRAY_API_BASE}/carts`);
