 ...
 * Run: TRAY_COUPON_ID=7 node skills/cupons/examples/cupom-relacionamento-marcas.node.mjs
...
const url = new URL(`${TRAY_API_BASE}/discount_coupons/brand_relationship/${TRAY_COUPON_ID}`);
