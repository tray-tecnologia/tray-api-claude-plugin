 ...
 * Run: TRAY_PRODUCT_ID=123 node skills/informacoes-adicionais/examples/info-adicional-atualizar-produto.node.mjs
...
const payload = JSON.parse(
  await readFile(new URL('./info-adicional-atualizar-produto.fixture.json', import.meta.url))
);

const url = new URL(`${TRAY_API_BASE}/products/${TRAY_PRODUCT_ID}/additional-info`);
