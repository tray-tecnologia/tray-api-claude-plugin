 ...
 * Run: TRAY_PRODUCT_ID=123 node skills/informacoes-adicionais/examples/info-adicional-vincular-produto.node.mjs
...
const payload = JSON.parse(
  await readFile(new URL('./info-adicional-vincular-produto.fixture.json', import.meta.url))
);
