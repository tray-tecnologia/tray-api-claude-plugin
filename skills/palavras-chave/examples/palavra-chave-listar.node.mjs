 ...
 * Run: node skills/palavras-chave/examples/palavra-chave-listar.node.mjs
 * Doc: https://developers.tray.com.br/#apis-de-palavras-chave
 * Quando usar: paginar palavras-chave de SEO da loja. Máximo 50 itens por página.
...
const url = new URL(`${TRAY_API_BASE}/keywords`);
