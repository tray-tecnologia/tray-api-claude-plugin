#!/usr/bin/env node
/**
 * Exemplo: Consultar dados do carrinho via API Tray
 * Run: TRAY_CART_SESSION_ID=abc123 node skills/carrinho-compras/examples/carrinho-consultar.node.mjs
 * Doc: https://developers.tray.com.br/#apis-de-carrinho-de-compra
 * Quando usar: obter os dados básicos de um carrinho pela sessão.
